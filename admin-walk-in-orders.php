                ...
                <?php
                  ...
                  if($count>0)
                  {
                      while($row=mysqli_fetch_assoc($res))
                      {
                          ...
                          $walkinorderID = $row['walkinorderID'];
                            ...
                            <span style="font-weight: bolder;">
                                ...
                                <li> <br>
                                    ...
                                    <div class="top-cat-list__title">
                                        ...
                                        <a href="admin-delete-walk-in-orders.php?id=<?php echo $row['productID']; ?>" style="color: #ffffff; border: none; background: rgb(0, 97, 247, .8); border-radius: .5rem; text-align: center; padding: 1rem 1.5rem;">Remove</a>
                                    </div>
                                    </li>
