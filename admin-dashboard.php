                            ...
                            <article class="stat-cards-item">
                                ...
                                <div class="stat-cards-info">
                                    <p class="stat-cards-info__num">
                                        ...
                                        $sql = "SELECT SUM(cquantity) FROM orderhistory;";
                                        $res = mysqli_query($dbcon, $sql);
                                        $count = mysqli_num_rows($res);
                                        if ($count > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                                echo "" . $row['SUM(cquantity)'];
                                        ?>
                                        <?php
                                            }
                                        } else {
                                    ...
                                    <p class="stat-cards-info__title">Walk-in product orders</p>
                                    ...
                                    <p class="stat-cards-info__title">Walk-in orders</p>
                                </div>
                            </article>
                        </div>
                            ...
                            <article class="stat-cards-item">
                                ...
                                <div class="stat-cards-info">
                                    ...
                                    <p class="stat-cards-info__num">
                                        ...
                                        $sql = "SELECT SUM(productQuantity) FROM placedorders;";
                                        $res = mysqli_query($dbcon, $sql);
                                        $count = mysqli_num_rows($res);
                                        if ($count > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                                echo "" . $row['SUM(productQuantity)'];
                                        ?>
                                        <?php
                                            }
                                        } else {
                                    ...
                                    <p class="stat-cards-info__title">Online product orders</p>
                                    ...
                                    <p class="stat-cards-info__title">Online orders</p>
                                </div>
                            </article>
                        </div>
                            ...
                            <article class="stat-cards-item">
                                ...
                                <div class="stat-cards-info">
                                    <p class="stat-cards-info__num">₱
                                        ...
                                        $sql = "SELECT SUM(ccapital) FROM orderhistory;";
                                        $res = mysqli_query($dbcon, $sql);
                                        $count = mysqli_num_rows($res);
                                        if ($count > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                                echo "" . $row['SUM(ccapital)'];
                                        ?>
                                        <?php
                                            }
                                        } else {
                                    ...
                                    <p class="stat-cards-info__title">Total capital</p>
                                    ...
                                    <p class="stat-cards-info__num"> ₱
                                        ...
                                        $sql = "SELECT SUM(ccost-ccapital) FROM orderhistory;";
                                        $res = mysqli_query($dbcon, $sql);
                                        $count = mysqli_num_rows($res);
                                        if ($count > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                                echo "" . $row['SUM(ccost-ccapital)'];
                                        ?>
                                        <?php
                                            }
                                        } else {
                                    ...
                                    <p class="stat-cards-info__title">Total net income</p>
                                </div>
                            </article>
                        </div>
                            ...
                            <article class="stat-cards-item">
                                ...
                                <div class="stat-cards-info">
                                    ...
                                    <p class="stat-cards-info__num">
                                        ...
                                        $sql = "SELECT * FROM placedorders WHERE orderStatus='On the way';";
                                        $res = mysqli_query($dbcon, $sql);
                                        $count = mysqli_num_rows($res);
                                        if ($count > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                    ...
                                    <p class="stat-cards-info__title">On the way</p>
                                    ...
                                    <p class="stat-cards-info__num">
                                        ...
                                        $sql = "SELECT * FROM placedorders WHERE orderStatus='Delivered';";
                                        $res = mysqli_query($dbcon, $sql);
                                        $count = mysqli_num_rows($res);
                                        if ($count > 0) {
                                                echo "" . $count;
                                    ...
                                    <p class="stat-cards-info__title">Delivered</p>
                                    ...
                                    <p class="stat-cards-info__num">
                                        ...
                                        $sql = "SELECT * FROM placedorders WHERE orderStatus='Canceled';";
                                        $res = mysqli_query($dbcon, $sql);
                                        $count = mysqli_num_rows($res);
                                        if ($count > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                    ...
                                    <p class="stat-cards-info__title">Canceled</p>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-6 col-xl-3">
