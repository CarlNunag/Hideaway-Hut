          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="customer-menu.php">Menu <span class="sr-only">(current)</span> </a>
              </li>
              <li class="nav-item">
        ...
        <div class="row grid">
          <table width="90%" style="margin-left: 20px; border-collapse:collapse; color: midnightblue; font-size: 12px;">
            <tbody>
              ...
              $count = 1;
              $sel_query = "Select * from useraccount where userID='$userID'";
                    ...
                    <div class="box">
                      <div>
                        ...
                        <div class="detail-box">
                          ...
                          <div class="options">
                            <h6>
                            Delivery Address: <?php echo $row["deliveryAddress"]; ?>
