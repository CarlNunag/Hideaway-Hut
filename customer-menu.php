                    ...
                    <div class="box">
                      <div>
                        ...
                        <div class="detail-box">
                          ...
                          <div class="options">
                            <h6 style="font-size: 1.2rem; color: #000000;">
                              ₱ <?php echo $row["ccost"]; ?>
                            </h6>
                          </div>
                          <input style="display:none;" name="userID" type="text" value="<?php echo $_SESSION['userID']; ?>">
                          <input style="display:none;" name="productID" type="number" value="<?php echo $row["id"]; ?>">
                          <input style="display:none;" name="productName" type="text" value="<?php echo $row["productname"]; ?>">
                          <input style="display:none;" name="productPrice" type="number" value="<?php echo $row["ccost"]; ?>">
                          
                          <input id="quantity-input" name="productQuantity" type="number" value="0" style="margin-left: 35%; width: 30%; height: 2.5rem; font-size: 1.2rem;border: .1rem solid rgb(0, 97, 247, .7); border-radius: 1rem; text-align: center; font-weight: bolder;"> <br> <br>
                          
                          <input style="display:none;" name="orderID" type="number" value="<?php echo rand(1000, 9999); ?>">
                          <input id="add-to-bag-button" name="submit" type="submit" value="Add to Bag" style="color: #ffffff;width: 100%; height: 2.5rem; font-size: 1.2rem;border: none; background: rgb(0, 97, 247, 7); border-radius: 1rem; text-align: center;">
                        </div>
                      </div>
                    </div>
                  </form>
