...
<div class="page-flex">
  ...
  <div class="container main-nav">
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">Update Customer Account</h2>
        ...
        <div class="row">
          <div class="col-lg-9">
            <div class="users-table table-wrapper">
                ...
                <form class="updateform" action="update-customer-account-processor.php">
                    
                    <input type="text" name="userID" value="" placeholder="userID" pattern="(?=.*\d).{1,}" required> <br> <br>
                            
                            <input type="text" name="accountStatus" value="" placeholder="Account Status" pattern="(?=.*[a-z])(?=.*[A-Z]).{4,}" required> <br> <br>
