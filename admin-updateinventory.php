...
<head>
  ...
  <title>Hideaway Hut | Update Inventory</title>
  <!-- Favicon -->
...
<div class="page-flex">
  ...
  <div class="container main-nav">
    <div class="main-nav-start">
        <h2 class="main-title">Update Inventory</h2>
    </div>
        ...
        <div class="row">
          <div class="col-lg-9">
            <div class="users-table table-wrapper">
                ...
                <form class="updateform" action="admin-updateinventoryprocessor.php">
                            
                            <input type="text" name="id" value="<?php echo $row['id']; ?>" placeholder="ID" pattern="(?=.*\d).{1,}" required> <br> <br>
                            
                            <input type="text" name="productname" value="<?php echo $row['productname']; ?>" placeholder="Product Name" pattern="(?=.*[a-z])(?=.*[A-Z]).{4,}" required> <br> <br>
                            
                            <input type="text" name="cquantity" value="<?php echo $row['cquantity']; ?>" placeholder="Quantity" pattern="(?=.*\d).{1,}" required> <br> <br>
                            
                            <input type="text" name="ccost" value="<?php echo $row['ccost']; ?>" placeholder="Cost" pattern="(?=.*\d).{1,}" required> <br> <br>
                            
                            <input type="text" name="ccapital" value="<?php echo $row['ccapital']; ?>" placeholder="Capital" pattern="(?=.*\d).{1,}" required> <br> <br>
