...
<head>
  ...
  <title>Hideaway Hut | Customers</title>
  <!-- Favicon -->
      ...
      <nav class="main-nav--bg">
        <div class="container main-nav">
          <div class="main-nav-start">
              <h2 class="main-title">Account table</h2>
          </div>
            ...
            <div class="nav-user-wrapper">
              <button href="##" class="nav-user-btn dropdown-btn" title="My profile" type="button">
                ...
                <span class="nav-user-img">
                  <picture>
                    <source srcset="avatar-illustrated-02.webp" type="image/webp"><img
                      src="avatar-illustrated-02.png" alt="User name"></picture>
                </span>
              </button>
            ...
            <div class="col-lg-9">
              ...
              <div class="col-md-6 col-xl-3">
                            <article class="stat-cards-item">
                                    ...
                                    <p class="stat-cards-info__title">Registered accounts</p>
                            </article>
                        </div>
                ...
                <table class="posts-table">
                  <thead>
                    <tr class="users-table-info">
                      ...
                      <th style="width: 2rem;">User Name</th>
                      <th style="width: 5rem;">Delivery Address</th>
                      <th style="width: 2rem;">Contact Number</th>
                      <th style="width: 2rem;">Account Status</th>
                    ...
                    <tr>
                      ...
                      <span class="p-relative">
                        ...
                        <ul class="users-item-dropdown dropdown">
                            <li><a href="update-customer-account.php?userID=<?php echo $row['userID']; ?>">Update</a></li>
                          <li><a href="admin-delete-customer-account.php?userID=<?php echo $row['userID']; ?>">Remove</a></li>
                        </ul>
                      </span>
                    </td>
                    </tr>
