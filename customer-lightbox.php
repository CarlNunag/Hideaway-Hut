    ...
    <main class="form fluid-form">
        ...
        <p id="heading-2">
            ...
            <p id="quantity-box">
                ...
                <input style="display:none;" name="productID" type="text" value="<?php echo $row["productID"]; ?>">
            ...
            <p id="delivery-address">
                <input id="delivery-address-input" type="text" name="deliveryAddress" placeholder="Add Delivery Address" value="<?php echo $row[" deliveryAddress"];?>" pattern="(?=.*[a-z])(?=.*[A-Z]).{10,}" required>
