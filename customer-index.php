          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              <li class="nav-item active">
                <a class="nav-link" href="customer-index.php">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <div class="btn-box">
                      <a href="customer-menu.php" class="btn1" style="color: #ffffff; border: none; background: rgb(0, 97, 247, .8); border-radius: 1rem; text-align: center;">
                        Order Now
                      </a>
                    </div>
                  </div>
