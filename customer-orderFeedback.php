        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="customer-myFeedbacks.php">Feedback </a>
              </li>
            </ul>
        ...
        <div class="col-md-6">
          <div class="detail-box">
            <div class="heading_container">
              <h2>
                Do you have service concerns? Send us a feedback
              </h2>
            </div>

            <form action="customer-feedbackSubmit.php">
            <input id="orderID" type="text" name="orderID" value="">
            <p>
                Feedback <br>
                <input id="feedback" type="text" name="feedback" placeholder="Please type here your feedback" value="">
